// src/components/steps/step5/calculated-sections/SectionBladeGeometry.tsx
...
export const SectionBladeGeometry: React.FC = () => {
    const { t } = useTranslation();
    const { step1Input, step3Output, decimalPlaces } = useFanStore();
        ...
        <>
            ...
            {sections.map((section) => (
                <CalculatedDataRow
                    ...
                    symbol={
                        <>
                            t<sub>{section.sectionIndex}</sub>
                        </>
                    }
            ...
            {sections.map((section) => (
                <CalculatedDataRow
                    ...
                    symbol={
                        <>
                            l/t<sub>{section.sectionIndex}</sub>
                        </>
                    }
            ...
            {sections.map((section) => (
                <CalculatedDataRow
                    ...
                    symbol={
                        <>
                            l<sub>{section.sectionIndex}</sub>
                        </>
                    }
            ...
            {sections.map((section) => (
                <CalculatedDataRow
                    ...
                    symbol={
                        <>
                            (C<sub>a</sub>l/t)<sub>{section.sectionIndex}</sub>
                        </>
                    }
            ...
            {sections.map((section) => (
                <CalculatedDataRow
                    ...
                    symbol={
                        <>
                            &gamma;<sub>m,{section.sectionIndex}</sub>
                        </>
                    }
            ...
            {sections.map((section) => (
                <CalculatedDataRow
                    ...
                    symbol={
                        <>
                            &epsilon;<sub>{section.sectionIndex}</sub>
                        </>
                    }
            ...
            {sections.map((section) => (
                <CalculatedDataRow
                    ...
                    symbol={
                        <>
                            &Delta;&gamma;<sub>1,{section.sectionIndex}</sub>
                        </>
                    }
            ...
            {sections.map((section) => (
                <CalculatedDataRow
                    ...
                    symbol={
                        <>
                            &Delta;&gamma;<sub>{section.sectionIndex}</sub>
                        </>
                    }
